    ...
    public class ThirdCategoryAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> CreateThirdCategory([FromBody] ThirdCategoryCreateDTO createDTO)
        {
            ...
            try
            {
                ...
                //}
                if (await _unitOfWork.ThirdCategory.GetAsync(u => u.ThirdCategoryName.ToLower() == createDTO.ThirdCategoryName.ToLower() && u.SecondCategoryId == createDTO.SecondCategoryId) != null)
                {
