    ...
    public class SecondCategoryAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> CreateSecondCategory([FromBody] SecondCategoryCreateDTO createDTO)
        {
            ...
            try
            {
                ...
                //}
                if (await _unitOfWork.SecondCategory.GetAsync(u => u.SecondCategoryName.ToLower() == createDTO.SecondCategoryName.ToLower() && u.FirstCategoryId == createDTO.FirstCategoryId) != null)
                {
