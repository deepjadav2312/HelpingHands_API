...
namespace HelpingHands_Web.Areas.Admin.Controllers
{
    ...
    public class AmenityController : Controller
    {
        ...
        public async Task<IActionResult> CreateAmenity()
        {
            ...
            {
                serviceVM.FirstCategoryList = JsonConvert.DeserializeObject<List<FirstCategoryDTO>>
        ...
        public async Task<IActionResult> CreateAmenity(AmenityCreateVM model)
        {
            ...
            {
                model.FirstCategoryList = JsonConvert.DeserializeObject<List<FirstCategoryDTO>>
        ...
        public async Task<IActionResult> UpdateAmenity(int id)
        {
            ...
            if (response != null && response.IsSuccess)
            {
                amenityVM.FirstCategoryList = JsonConvert.DeserializeObject<List<FirstCategoryDTO>>
